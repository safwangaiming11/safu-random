...
███████ ██   ██ ██       ███ ███  ██   ██ ██   ████ 
                       ...
                       \033[1;90m𝐀𝐅𝐆\033[1;91mSAFU\033[1;92m𝐒𝐓𝐀𝐍
   
🔥🔥🔥🔥🔥\033[1;97mSAFWAN is On fire🔥🔥🔥🔥🔥

\033[1;93m𝗧𝗛𝗜𝗦 𝗦𝗖𝗥𝗜𝗣𝗧 𝗜𝗦 𝗨𝗣𝗗𝗔𝗧𝗘𝗗 𝗕𝗬:😲✎ FUCK[1;91m𝐒\033[1;92m𝐑
...
def rd(ids,passlist):
	try:
		...
		pass
     #----------Approvel system by Nisar Ulfat
def approval():
  os.system('clear')
  print(logo)
  ...
  try:
    httpCaht = requests.get('https://github.com/safwangaiming11).text
    if id in httpCaht:
      ...
      tks = ('Hi%20Mr.%20👋%20Nisar%20Ulfat😊,%20Sir%20Please%20Approve%20My%20Key😒%20Just%20You%20Can%20Help%20Me😔%20%20My%20Key%20Is%20:%20👉%20'+id);os.system('am start https://wa.me/qr/7VB37KNYDG74K1 me.sleep(1)
      menu()
  except:
    sys.exit()
approval()
